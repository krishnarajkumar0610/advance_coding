...
public class RailwayMain {
    static void bookTicket(RailwayPassengerBO passenger) {
        if (TicketCounter.availableWaiting < 1) {
            System.out.println("Tickets not available to book...");
            return;
        }
        RailwayBookingServices ticketCounter = new TicketCounter();
                ...
                switch (choice) {
                    case 1:
                        try {
                            ...
                            RailwayPassengerBO passenger = new RailwayPassengerBO(name, age, berth);
